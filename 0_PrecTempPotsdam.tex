...
\usepackage[style=authoryear, natbib=true, url=false, dashed=false, isbn=false, firstinits=true, uniquename=init, uniquelist=false, sorting=nyt, backend=biber, maxbibnames=99, maxcitenames=2, mincitenames=1]{biblatex}
\renewbibmacro{in:}{}
...
%\href{http://www.dwd.de/bvbw/appmanager/bvbw/dwdwwwDesktop?_nfpb=true&_pageLabel=_dwdwww_klima_umwelt_klimadaten_deutschland&T82002gsbDocumentPath=Navigation\%2FOeffentlichkeit\%2FKlima__Umwelt\%2FKlimadaten\%2Fkldaten__kostenfrei\%2Fausgabe__stundenwerte__node.html\%3F__nnn\%3Dtrue}{DWD Archive}.
%As the link is frequently changed, reach it via 
...
\begin{figure}[H] % 10
\includegraphics[width=0.71\textwidth]{figure/10_fitdist_gofProp-effect.pdf}
